...
function cartCount() {
    ...
    var existingCartProduct = $.cookie('myAddToCartCookie');
    if (existingCartProduct != "" && existingCartProduct != undefined && existingCartProduct != null)
    {
        products = existingCartProduct.split('-');
    }
    else {
        products = [];
    }
